import 'package:coursius_project/controller/controllerlogin.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Icon changingIcons = const Icon(Icons.visibility_off_outlined);
  @override
  Widget build(BuildContext context) {
    ControllerLogin _controllerlogin = Get.put(ControllerLogin());
    return Scaffold(
      body: GetBuilder<ControllerLogin>(
          init: _controllerlogin,
          initState: (state) {
            _controllerlogin.obscureTextChanging();
          },
                                ...
                                suffixIcon: InkWell(
                                    onTap: () {
                                      if (obscureTextInput == true) {
                                        changingIcons = c.iconsChanging();
                                        return obscureTextInput =
                                            c.obscureTextChanging();
                                        //   setState(() {
                                        // });
                                      } else {
                                        changingIcons = c.iconsChanging();
